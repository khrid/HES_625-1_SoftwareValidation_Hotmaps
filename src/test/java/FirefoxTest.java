...
public class FirefoxTest {
    ...
    void districtHeatingCMGenevaEqualsToValue() {
        ...
        //layerLAU2.click();
        actions.moveToElement(layerLAU2).click().perform();
        WebElement placeInput = driver.findElement(By.id("place-input"));
    ...
    void borderLAU2orNUTS3Danemark() {
        ...
        WebElement layerLAU2 = driver.findElement(By.xpath("/html/body/app-root/htm-map/div[2]/div/div[2]/div[2]/div[1]/section/div[1]/label[5]"));
        //layerLAU2.click();
        actions.moveToElement(layerLAU2).click().perform();
        ...
        actions.moveToElement(layerNUTS3).click().perform();
    ...
    void grossFloorSubgroupLayers() {
        ...
        actions.moveToElement(layerMenu).click().perform();
